...
const messages = defineMessages({
  menuItemsHeader: {
    id: 'secondarymenu-menuitems-header',
    defaultMessage: 'Menu items',
  },
  addMenuPath: {
    id: 'secondarymenu-add-rootpath',
    defaultMessage: 'Add menu path',
  },
  deleteMenuPath: {
    id: 'secondarymenu-delete-menupath',
    defaultMessage: 'Delete menu path',
  },
  deleteButton: {
    id: 'secondarymenu-delete-button',
    defaultMessage: 'Delete',
  },
  root_path: {
    id: 'secondarymenu-rootpath',
    defaultMessage: 'Root path',
  },
  addMenuItem: {
    id: 'secondarymenu-addmenuitem',
    defaultMessage: 'Add menu item',
  },
  moveMenuItemUp: {
    id: 'secondarymenu-move-menuitem-up',
    defaultMessage: 'Move menu item up',
  },
  moveMenuItemDown: {
    id: 'secondarymenu-move-menuitem-down',
    defaultMessage: 'Move menu item down',
  },
  emptyActiveMenuPath: {
    id: 'secondarymenu-emptyActiveMenuPath',
    defaultMessage: 'Select a menu path',
  },
  emptyActiveMenuItem: {
    id: 'secondarymenu-emptyActiveMenuItem',
...
const SecondaryMenuConfigurationWidget = ({
  value,
  id,
  onChange,
  required,
  ...
  return (
    <div className="secondary-menu-configuration-widget">
                ...
                <Segment>
                  {activeMenu > -1 && activeMenu < menuConfiguration.length ? (
                    <Grid>
                      <Grid.Column
                        width={12}
                        className="secondarymenu-rootpath-segment"
                      >
                        <TextWidget
                          id="rootPath"
                      ...
                      <Grid.Column width={4}>
                        <Header as="h2" className="secondarymenu-items-header">
...
export default SecondaryMenuConfigurationWidget;
